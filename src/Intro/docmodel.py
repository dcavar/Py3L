...
# this is just for Komodo Edit Command Output to cope with Unicode
...
def filterJunk(fp, junkstring):
   for key in junkstring:
      if key in fp:
         del fp[key]
   if '' in fp:
      del fp['']
...
if __name__ == '__main__':
   ...
   for i in sys.argv[1:]:
      processFile(i, fp)
      #print(tokenize(open(i, mode='r').read()))

   filterJunk(fp, junkstring)
